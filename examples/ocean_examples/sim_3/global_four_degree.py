...
class GlobalFourDegreeSetup(VerosSetup):
    ...
    def set_parameter(self, vs):
        ...
        vs.K_iso_0 = var_vals["kappa_iso"]  # kappa_iso_loaded
        ...
        vs.tke_mxl_choice = 2
        vs.kappaM_min = 2e-4
        vs.kappaH_min = var_vals["kappa_min"]  # kappaH_min_loaded
        ...
        vs.K_gm_0 = var_vals["kappa_gm"]  # kappa_gm_loaded
        vs.enable_eke = False
        vs.enable_idemix = False
